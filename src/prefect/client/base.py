...
from prefect.settings import (
    ...
    PREFECT_APP_LIFESPAN_CONTEXT_STARTUP_TIMEOUT,
    PREFECT_APP_LIFESPAN_CONTEXT_SHOUTDOWN_TIMEOUT,
)
    ...
    async with lock:
        if key in APP_LIFESPANS:
            ...
            APP_LIFESPANS[key] = context = LifespanManager(
                ...
                shutdown_timeout = PREFECT_CLIEN_TLIFESPAN_CONTEXT_SHOUTDOWN_TIMEOUT,
            )
            APP_LIFESPANS_REF_COUNTS[key] = 1
